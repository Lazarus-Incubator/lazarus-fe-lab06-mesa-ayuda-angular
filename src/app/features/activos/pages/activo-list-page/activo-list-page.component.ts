/**
 * Activo List Page Component module.
 *
 * @remarks Provides the TypeScript implementation for `src/app/features/activos/pages/activo-list-page/activo-list-page.component.ts`.
 */
